...
Nstack = 3; % Number of stator stacks
coil_to_coil_gap = 0.1; %ignoring coil thicknes, mid plane of the coils should be considered
Coil_z_min = -0.5 *coil_to_coil_gap * Nstack %minimum coil z(-) for the outer stack
...
for s = 1:Nstack+1 %Create Nstack+1 number of coils in the axial direction, midplane Z=0
